...
//      $k = mysqli_query($dbcon, "INSERT INTO `resseller` (`username` ,`unsoldb` ,`soldb` ,`isold` ,`iunsold` ,`activate`,`btc`,`withdrawal`,`allsales`,`lastweek`)
// VALUES ('$user',  '0',  '0',  '0',  '0',  '$date','','',null,null") or die(mysqli_error());

//  $k=mysqli_query($dbcon, "INSERT INTO `resseller`(`username`, `unsoldb`, `soldb`, `isold`, `iunsold`, `activate`, `btc`, `withdrawal`, `allsales`, `lastweek`) 
//  VALUES ('$user','0','0','0','0','$date','','',null,null")or die(mysqli_error($dbcon));
$k=mysqli_query($dbcon, "INSERT INTO resseller
(username,unsoldb,soldb,isold,iunsold,activate,btc,withdrawal,allsales,lastweek)
VALUES
('$user','0','0','0','0','$date','','',null,null)") or die(mysqli_error($dbcon));
 }else{
