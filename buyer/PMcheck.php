    ...
    if ($row['method'] == "PerfectMoney") {
        ...
        if($amount>= $row['amount']){
            if ($row['state'] == "paid") {
                ...
                echo $blade->run("template", ["stop" => "1", "time" => date("d/m/Y h:i:s a"), "btc" => $amount, "state" => "Paid", "error" => "1", "errorTXT" => $msg]);
            }
            ...
            echo $blade->run("template", ["stop" => "0", "time" => date("d/m/Y h:i:s a"), "btc" => $amount, "state" => "Not Paid", "error" => "0", "errorTXT" => "0"]);
        }
    }
?>
